...
class _MovieWidgetState extends State<MovieWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    // FutureBuilder(
    //   future: checkMovieInWatchList(widget.movieModel.id ?? 0),
    //   builder: (context, snapshot) {
    //     if (snapshot.connectionState == ConnectionState.waiting) {
    //       return const Center(
    //         child: CircularProgressIndicator(),
    ...
    //         return Center(child: Text('Error: ${snapshot.error}'));
    //       } else {
    //         isMovieInWatchList = snapshot.data ?? false;
    //         return Padding(
    //           padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 20),
    //           child: Row(
    //             children: [
    ...
    //                         isMovieInWatchList = !isMovieInWatchList;
    //                         setState(() {
    //                           checkMovieInWatchList(widget.movieModel.id ?? 0);
    //                         });
    //                       },
    //                       child: Stack(
    //                         alignment: Alignment.center,
...
// Future<bool> checkMovieInWatchList(num id) async {
//   return await FirebaseManager.isMovieInWatchList(id);
// }
}
